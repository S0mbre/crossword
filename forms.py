# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 15:20:23 2019
...
class SettingsDialog(BasicDialog):
    ...
    def add_pages(self):
        ...
        self.layout_gb_print_margins.addRow('Left, mm', self.spin_margin_left)
        self.layout_gb_print_margins.addRow('Right, mm', self.spin_margin_right)
        self.layout_gb_print_margins.addRow('Top, mm', self.spin_margin_top)
        self.layout_gb_print_margins.addRow('Bottom, mm', self.spin_margin_bottom)
